...
RESOURCE_CATALOG: list[dict] = [
    ...
    {"code": "recipe.create", "name_cn": "关系配方新建与复制", "type": "button", "parent_code": "asset.recipe.view"},
    {"code": "recipe.edit", "name_cn": "关系配方草稿编辑", "type": "button", "parent_code": "asset.recipe.view"},
    {"code": "recipe.review", "name_cn": "关系配方审核", "type": "button", "parent_code": "asset.recipe.view"},
    {"code": "recipe.activate", "name_cn": "关系配方启停", "type": "button", "parent_code": "asset.recipe.view"},
    {"code": "recipe.sql_generate", "name_cn": "关系配方 SQL 预览", "type": "button", "parent_code": "asset.recipe.view"},
    ...
    {"code": "asset.quality.ai.view", "name_cn": "AI质控查看", "type": "page", "parent_code": "asset.quality.view"},
    {"code": "asset.quality.ai.analyze", "name_cn": "AI质控分析", "type": "button", "parent_code": "asset.quality.ai.view"},
    ...
    {"code": "ops.sql.review", "name_cn": "SQL 模板审核", "type": "button", "parent_code": "ops.sql.view"},
    {"code": "ops.sql.execute", "name_cn": "SQL 执行", "type": "button", "parent_code": "ops.sql.view"},
    {"code": "ops.sql.audit", "name_cn": "SQL 审计", "type": "button", "parent_code": "ops.sql.view"},
